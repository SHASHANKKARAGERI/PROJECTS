				...
				<?php
					...
					<?php
						...
						?>
							...
							<?php echo "Price : ".$row['price'].' /-'; ?><br><br>

							<a href="editProduct.php?pid=<?php echo $row['pid']; ?>">
    						<button style="background:green;color:white;padding:8px 15px;border:none;border-radius:5px;">
        					Edit Price
    						</button>
							</a>

							<a href="deleteProduct.php?pid=<?php echo $row['pid']; ?>"
   							onclick="return confirm('Are you sure you want to remove this product?');">
    						<button style="background:red;color:white;padding:8px 15px;border:none;border-radius:5px;">
        					Remove
    						</button>
							</a>
							</blockquote>
